...
enum class MessageChannel {
    ...
    DISPLAY_VIEW_TEXT_BRIDGE { override val messageClass = TextViewMessage::class },
    DISPLAY_VIEW_CONFIG_BRIDGE { override val messageClass = ViewMessage::class },
    ...
    AI_VIEW_BRIDGE { override val messageClass = ViewMessage::class },
