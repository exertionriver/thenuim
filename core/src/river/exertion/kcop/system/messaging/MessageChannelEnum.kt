...
enum class MessageChannelEnum {
    ...
    DISPLAY_VIEW_AUDIO_BRIDGE { override val messageClass = AudioViewMessage::class },
    DISPLAY_VIEW_MENU_BRIDGE { override val messageClass = MenuViewMessage::class },
    ...
    MENU_VIEW_BRIDGE { override val messageClass = MenuViewMessage::class },
