...
class FlagSetEvent(
    ...
    override fun execEvent(previousEvent : Event?) {
        ...
        MessageChannel.NARRATIVE_FLAGS_BRIDGE.send(null, NarrativeFlagsMessage(NarrativeFlagsMessage.NarrativeFlagsMessageType.SetPersistFlag, flagKey, NarrativeImmersion.FlagSetValue) )
    }
}
