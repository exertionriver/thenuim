...
class CounterPlusEvent(
    ...
    override fun execEvent(previousEvent : Event?) {
        ...
        MessageChannelHandler.send(NarrativeFlagsBridge, NarrativeFlagsMessage(NarrativeFlagsMessage.NarrativeFlagsMessageType.AddToCounter, counterKey, (1).toString() ) )
    }
}
